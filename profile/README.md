...
- Consider using a [CODEOWNERS](https://docs.github.com/en/repositories/managing-your-repositorys-settings-and-features/customizing-your-repository/about-code-owners) file to define code ownership and ensure the appropriate people are notified of Dependabot pull requests.
